...
![String slice vs string literal](img/string-slice-vs-string-literal-1.png)
...
println!("str4: {str4}");               // output ➜ str4: Hiroyuki Sawano
println!("str4_slice1: {str4_slice1}"); // output ➜ str4_slice1: Hiroyuki Sawano
```
...
![String slice vs string literal](img/string-slice-vs-string-literal-2.png)
...
{
    let str5_slice1: &mut str = str5.as_mut_str();
    println!("str5_slice1: {str5_slice1}");  // output ➜ str5_slice1: Hans Zimmer
}
println!("str5: {}", str5);                  // output ➜ str5: Hans Zimmer
```
...
println!("str6: {str6}");               // output ➜ str6: John Towner Williams
println!("str6_slice1: {str6_slice1}"); // output ➜ str6_slice1: John Towner Williams
println!("str6: {str6}");
```
...
Berbeda dengan data bertipe `&str` **(di paragraf ini dan setelahnya yang kita bahas adalah data yang dari awal tipe-nya sudah `&str`, bukan data hasil operasi pinjam dari `String`)**, data bertipe `&str` adalah fixed dan immutable. Konversi data `&str` ke `String` menghasilkan data baru dengan owner baru. Bisa dibilang sangat terbatas apa yang bisa kita lakukan pada tipe data `&str`.
...
Dalam situasi umum dianjurkan untuk menggunakan `&str`, kecuali jika yang dibutuhkan memang **owned** string.
